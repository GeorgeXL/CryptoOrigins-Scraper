...
import { getOpenAIClient, evaluateEventSummary, enhanceEventSummary, compareArticleSets } from "./services/openai";
...
// OpenAI client is now lazy-loaded via getOpenAIClient()
