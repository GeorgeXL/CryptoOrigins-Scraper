...
export const tagMetadata = pgTable("tag_metadata", {
  id: uuid("id").primaryKey().defaultRandom(),
  name: text("name").notNull(),
  category: text("category").notNull(),
  parentTagId: uuid("parent_tag_id").references(() => tagMetadata.id, { onDelete: "set null" }), // Self-referencing for hierarchy
